...
export default function ProfileCard(props) {
  ...
  const buttonThreeSixFourNineTwoSixEightNineOnClick = useDataStoreDeleteAction(
    { id: pet?.id, model: Pet, schema: schema }
  );
  const buttonThreeSixFourNineTwoSixNineThreeOnClick = useDataStoreUpdateAction(
  ...
  return (
    ...
    >
      <Button
        ...
        children="Delete"
        onClick={() => {
          buttonThreeSixFourNineTwoSixEightNineOnClick();
        }}
      ...
      <Button
        ...
        children="Update"
        onClick={() => {
          buttonThreeSixFourNineTwoSixNineThreeOnClick();
        }}
        {...getOverrideProps(overrides, "Button36492693")}
      ></Button>
    </Flex>
  );
}
